...
export const CATEGORY_DROPDOWN_SAVED_STATE_REDUCER_KEY =
  'savedCategoryCheckBoxes';
export const CATEGORY_DROPDOWN_TEMP_STATE_REDUCER_KEY =
...
export const ACCOUNT_DROPDOWN_SAVED_STATE_REDUCER_KEY =
